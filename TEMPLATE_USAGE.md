...
1. Update the repository name everywhere (`README.md`, `AGENTS.md`, `doc_human/project/*.md`).
...
- Update `AGENTS.md` `context_routes` so they only point to docs that exist in that language.
...
- [ ] `AGENTS.md` updated with your modules and docs.

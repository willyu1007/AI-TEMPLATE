...
language: en
version: example
purpose: Example module documentation package
---
# Example Module
...
Use this example as a reference to keep your own modules concise, English-only, and aligned with `config/language.yaml`.
